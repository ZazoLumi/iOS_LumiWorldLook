...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        highlightIconColor = UIColor.init(red: 180/255.0, green: 219/255.0, blue: 212/255.0, alpha: 1.0)
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.layer.cornerRadius = (UIImage(named:"Artboard 77xxhdpi")?.size.height)!/2
